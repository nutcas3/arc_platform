...
module ChaptersHelper
  ...
  CHAPTERS = [
    ...
    { country_key: 'chapters.countries.tanzania', image: 'country_tanzania.png', alt_key: 'chapters.alt_text.arc_tanzania' },
    { country_key: 'chapters.countries.uganda', image: 'country_uganda.png', alt_key: 'chapters.alt_text.arc_uganda' }
  ].freeze

  FEATURED_SPONSORS = [
    { image: 'sponsors/current/solutech_official.svg', link: 'https://solutech.co.ke', alt_key: 'sponsors.current.solutech' },
    { image: 'sponsors/current/app_signal.png', link: 'https://www.appsignal.com', alt_key: 'sponsors.current.app_signal' },
    { image: 'sponsors/current/ruby_central.png', link: 'https://rubycentral.org/', alt_key: 'sponsors.current.ruby_central' },
    ...
    { image: 'sponsors/current/typesense-logo.png', link: 'https://typesense.org/', alt_key: 'sponsors.current.typesense' },
    { image: 'sponsors/current/daystar.png', link: 'https://www.daystar.ac.ke/', alt_key: 'sponsors.current.daystar' },
    { image: 'sponsors/current/prosper.png', link: 'https://www.prosperhedge.com/', alt_key: 'sponsors.current.prosper' },
  ...
  PREVIOUS_SPONSORS = [
    ...
    { image: 'sponsors/previous/microverse.png', link: 'https://www.microverse.org/', alt_key: 'sponsors.previous.microverse' },
    { image: 'sponsors/previous/planet_argon.png', link: 'https://www.planetargon.com', alt_key: 'sponsors.previous.planet_argon' },
    { image: 'sponsors/previous/nairobits.png', link: 'https://www.nairobits.com/', alt_key: 'sponsors.previous.nairobits' },
    ...
    { image: 'sponsors/previous/friendly_rb.jpg', link: 'https://friendlyrb.com/', alt_key: 'sponsors.previous.friendly_rb' },
  ...
  SOCIALS = [
    { alt_key: 'social_media.twitter', link: 'https://twitter.com/ruby_african', image: 'brands_twitter.png', show: true },
    { alt_key: 'social_media.telegram', link: '#', image: 'brands_telegram.png',
      show: FeatureFlag.find_by(name: 'telegram')&.enabled },
    { alt_key: 'social_media.facebook', link: 'https://www.facebook.com/rubycommunity.africa', image: 'brands_facebook.png',
      show: true },
